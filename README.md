...
<body>
    ...
    <div id="teacher-list">
        ...
        <!-- Mehr Lehrerkarten nach diesem Beispiel -->
    ...
    <script>
        ...
        // Funktion zum Laden vorhandener Bewertungen aus LocalStorage
        function loadRatings() {
            ...
            for (const teacher in savedRatings) {
                ratings[teacher] = savedRatings[teacher];
                adjectives[teacher] = savedAdjectives[teacher];
            }
        }

        // Funktion zum Speichern von Bewertungen im LocalStorage
